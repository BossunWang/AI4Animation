...
namespace DeepPhase {
    public class QuadrupedPipeline : AssetPipelineSetup {
        ...
        private void ProcessAssets(MotionAsset asset) {
            ...
            asset.Scale = 0.01f;
            asset.Source.FindBone("mixamorig:Head").Alignment = new Vector3(0f, 0f, 0f);
            asset.Source.FindBone("mixamorig:LeftShoulder").Alignment = new Vector3(0f, 0f, 0f);
            asset.Source.FindBone("mixamorig:RightShoulder").Alignment = new Vector3(0f, 0f, 0f);
...

            {
                ...
                module.Clear();
                module.AddSensor("mixamorig:Hips", Vector3.zero, Vector3.zero, 0.2f*Vector3.one, 1f, LayerMask.GetMask("Ground"), ContactModule.ContactType.Translational, ContactModule.ColliderType.Sphere);
                module.AddSensor("mixamorig:Neck", Vector3.zero, Vector3.zero, 0.25f*Vector3.one, 1f, LayerMask.GetMask("Ground"), ContactModule.ContactType.Translational, ContactModule.ColliderType.Sphere);
                module.AddSensor("mixamorig:LeftHand", Vector3.zero, Vector3.zero, 1f/30f*Vector3.one, 1f, LayerMask.GetMask("Ground"), ContactModule.ContactType.Translational, ContactModule.ColliderType.Sphere);
                module.AddSensor("mixamorig:RightHand", Vector3.zero, Vector3.zero, 1f/30f*Vector3.one, 1f, LayerMask.GetMask("Ground"), ContactModule.ContactType.Translational, ContactModule.ColliderType.Sphere);
                module.AddSensor("mixamorig:LeftFoot", Vector3.zero, Vector3.zero, 1f/30f*Vector3.one, 1f, LayerMask.GetMask("Ground"), ContactModule.ContactType.Translational, ContactModule.ColliderType.Sphere);
                module.AddSensor("mixamorig:RightFoot", Vector3.zero, Vector3.zero, 1f/30f*Vector3.one, 1f, LayerMask.GetMask("Ground"), ContactModule.ContactType.Translational, ContactModule.ColliderType.Sphere);
